...
As resources are gathered, the building production object will establish a foundation for production of necessary units for the strategy. This object will work closely with the construction decision object in order to produce necessary buildings as soon as the resources are available.
...
United will be produced based on the scripted strategy, available resources, and opponent unit production. In later versions, this logic will more extensively responsive to opponent actions. For now, this object will follow the scripted strategy very closely and execute commands for units matching that fit that strategy.

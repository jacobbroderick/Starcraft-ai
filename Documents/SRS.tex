...
AI - artificial intelligence \linebreak
Agent - the program that will play Starcraft Brood War by itself \linebreak
Client - person or organization that has requested the project to be developed \linebreak
User - any future Oregon State University club member that wishes to interact with the artificial intelligence \linebreak
Starcraft Brood War - a real time strategy game created by Blizzard Entertainment \linebreak
...
\ganttbar[progress=75]{Requirements Document}{4}{6} \\

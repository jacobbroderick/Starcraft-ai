...
\ganttbar[progress=66]{Requirements Document}{4}{6} \\
\ganttbar[progress=none]{Technical Document}{5}{8} \\
\ganttbar[progress=none]{Design Document}{5}{8}
